        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div class="navbar-nav px-2 ">
                        ...
                        <a class="nav-item nav-link" href="Disclaimer.php">Terms and Conditions</a>
                        <a class="nav-item nav-link" href="CustomerInfo.php">Customer Information</a>
                        <a class="nav-item nav-link" href="DepositCalculator.php">Calculator</a>
                        <a class="nav-item nav-link" href="Complete.php">Complete</a>
                    </div>
            </nav>
        </header>
